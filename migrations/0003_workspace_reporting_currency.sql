...
INSERT INTO `__new_singleton_workspace`("id", "owner_user_id", "reporting_currency", "revision", "created_at", "updated_at") SELECT "id", "owner_user_id", 'USD', 0, "created_at", "updated_at" FROM `singleton_workspace`;--> statement-breakpoint
