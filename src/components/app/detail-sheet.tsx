...
import type { SheetSize } from "@/components/ui/sheet";
import {
	Tabs,
	TabsContent,
	TabsList,
...
export function DetailSheetSplit({
	className,
	children,
	...props
}: React.ComponentProps<"div">) {
...
export function DetailSheetMain({
	className,
	children,
	...props
}: React.ComponentProps<"div">) {
...
export function DetailSheetRail({
	className,
	children,
	...props
}: React.ComponentProps<"div">) {
	return (
		<div
			className={cn(
				"flex w-full min-w-0 shrink-0 flex-col lg:w-80",
				className,
			)}
			{...props}
		>
