...
requestSchemas.UpdateWorkspaceSettings.description = "System-only change of the workspace reporting currency, the interface locale, or both, using expectedRevision. At least one of the two is required. The currency is trimmed and upper-cased before the three-letter check; a stale revision returns 409.";
