...
const apiEndpoints: APIEndpoint[] = [
  ...
  { method: "GET", path: "/api/settings", description: "Read the workspace reporting currency and interface locale. Available to any active member with CRM read access." },
  { method: "PATCH", path: "/api/settings", description: "System changes the workspace reporting currency, interface locale, or both using expectedRevision; a stale edit returns 409." },
